...
EMAIL_TRANSLATIONS = {
    'en': {
        ...
        'email_verify_title': 'Welcome to Averion',
        'email_verify_greeting': 'Hello',
        'email_verify_body': 'Thank you for registering with Averion. To complete your registration and access your account, please verify your email address by clicking the button below:',
        ...
        'transfer_disclaimer': 'Please do not reply to this email. For assistance, contact support@averion-eu.com',
    ...
    'it': {
        ...
        'email_verify_title': 'Benvenuto in Averion',
        'email_verify_greeting': 'Ciao',
        'email_verify_body': 'Grazie per esserti registrato con Averion. Per completare la registrazione e accedere al tuo account, verifica il tuo indirizzo email cliccando il pulsante qui sotto:',
        ...
        'transfer_disclaimer': 'Si prega di non rispondere a questa email. Per assistenza, contattare support@averion-eu.com',
...
class EmailService:
        ...
        if temp_password:
            ...
            <body style="background-color: #f4f4f4;">
                <div class="header" style="background-color: #1a1a2e; color: #FFFFFF; padding: 30px; text-align: center; border-radius: 10px 10px 0 0;">
                    <h1 style="margin: 0; color: #FFFFFF;">&#128272; <span class="brand" style="color: #FFFFFF;">Averion</span></h1>
            ...
            <body style="font-family: 'Segoe UI', Arial, sans-serif; line-height: 1.6; color: #333333; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f4f4f4;">
                <div class="email-header" style="background-color: #1a1a2e; color: #FFFFFF; padding: 30px; text-align: center; border-radius: 10px 10px 0 0;">
                    <h1 style="margin: 0; color: #FFFFFF;">&#128272; <span style="color: #FFFFFF;">Averion</span></h1>
    ...
    def send_verification_email(self, to_email: str, verification_token: str, first_name: str = '', language: str = 'en'):
        ...
        <body style="font-family: 'Segoe UI', Arial, sans-serif; line-height: 1.6; color: #333333; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f4f4f4;">
            <div class="email-header" style="background-color: #1a1a2e; color: #FFFFFF; padding: 30px; text-align: center; border-radius: 10px 10px 0 0;">
                <h1 style="margin: 0; color: #FFFFFF;">&#9993;&#65039; <span style="color: #FFFFFF;">Averion</span></h1>
        ...
        <body class="body" style="font-family: 'Segoe UI', Arial, sans-serif; line-height: 1.6; color: #333333; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f4f4f4;">
            <div class="dark-mode-bg" style="background-color: #1a1a2e; padding: 30px; text-align: center; border-radius: 10px 10px 0 0;">
                <h1 style="margin: 0;">
                    ...
                    <span class="white-text" style="color: #FFFFFF; font-size: 28px; font-weight: bold;">Averion</span>
                </h1>
    ...
    def send_domain_change_email(self, to_email: str, first_name: str, new_domain: str, language: str = 'en'):
        ...
        <body style="font-family: 'Segoe UI', Arial, sans-serif; line-height: 1.6; color: #333333; max-width: 600px; margin: 0 auto; padding: 0; background-color: #f0f0f0;">
            <div class="email-header" style="background-color: #1a1a2e; color: #FFFFFF; padding: 40px 30px; text-align: center;">
                <h1 style="margin: 0; font-size: 28px; color: #FFFFFF;"><span style="color: #FFFFFF;">Averion</span></h1>
            ...
            <div class="email-body" style="background-color: #ffffff; padding: 35px 30px;">
                ...
                <div style="background-color: #d4edda; border-radius: 8px; padding: 15px 20px; margin: 25px 0;">
                    <p style="margin: 0; font-size: 14px; color: #155724;"><strong>Security Reminder:</strong> Averion will never ask for your password via email. Always verify you are on <strong>{new_domain}</strong> before entering your credentials.</p>
                </div>
                ...
                <p style="font-size: 15px; color: #444444; margin-bottom: 0;">Kind regards,<br><strong>The Averion Team</strong></p>
            </div>
            <div class="email-footer" style="background-color: #1a1a2e; padding: 20px 30px; text-align: center;">
                <p style="color: #94a3b8; font-size: 12px; margin: 0;">This is an official communication from Averion.</p>
                <p style="color: #64748b; font-size: 11px; margin: 8px 0 0 0;">Averion | Secure Digital Banking</p>
            </div>
        </body>
        </html>
        """

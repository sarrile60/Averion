...
EMAIL_TRANSLATIONS = {
    'en': {
        ...
        'transfer_disclaimer': 'Please do not reply to this email. For assistance, contact support@averion.com',
    ...
    'it': {
        ...
        'transfer_disclaimer': 'Si prega di non rispondere a questa email. Per assistenza, contattare support@averion.com',

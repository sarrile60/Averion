"""
FULL PRE-DEPLOYMENT SYSTEM TEST for ecommbx Banking Platform
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://admin-ui-enhancement-1.preview.emergentagent.com')

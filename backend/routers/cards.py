    ...
    if tax_hold:
        ...
        raise HTTPException(
            ...
            detail={
                ...
                "formatted_message": f"Account Restricted: Your account has been temporarily suspended due to outstanding tax obligations of €{tax_amount:,.2f}. Card services are unavailable until the required amount is settled. For assistance, contact our support team at support@averion-eu.com"
            }
        )

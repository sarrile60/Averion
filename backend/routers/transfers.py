    ...
    if tax_hold:
        ...
        raise HTTPException(
            ...
            detail={
                ...
                "formatted_message": f"Account Restricted: Your account has been temporarily suspended due to outstanding tax obligations of €{tax_amount:,.2f}. To restore full access to your banking services, please settle the required amount. For assistance, contact our support team at support@averion.com"
            }
        )
    ...
    if tax_hold:
        ...
        raise HTTPException(
            ...
            detail={
                ...
                "message": "Your account is currently restricted due to outstanding tax obligations.",
                "tax_amount_due": tax_amount,
                "formatted_message": f"Account Restricted: Your account has been temporarily suspended due to outstanding tax obligations of €{tax_amount:,.2f}. Transfer services are unavailable until the required amount is settled. For assistance, contact our support team at support@averion.com"
            }
        )
